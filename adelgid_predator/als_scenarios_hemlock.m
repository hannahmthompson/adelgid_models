...
% Plot of model results with varying values of z, 
% fixed proportion tips alive parameter
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% for each tested value of Hset/z (proportion tips alive parameter)
for Hset=[0.45 0.65 0.8 0.95]
