...
ylabel('A. tsugae Density', 'FontSize', 16)
...
ax.FontSize = 16;
%adelgid in black
plot(t_full ./ 52, a_final_plot, 'Color', [0.8, 0.8, 0.8], 'LineWidth', 3); 
xlabel('Time (years) starting week 43 (October)', 'FontSize', 16)
ylabel('A. tsugae density (per cm)', 'FontSize', 16)
ylim([0,37])

legend('Baseline','No predators', 'Location','northwest', 'FontSize', 16)

% save figure as .jpeg file
filename = ['ALS_ALS_A.jpeg'];
f = gcf;
...
ax.FontSize = 16;
%adelgid in black
plot(t_full ./ 52, a_final_plot, 'Color', [0.6, 0.6, 0.6], 'LineWidth', 3); 
xlabel('Time (years)', 'FontSize', 16)
ylabel('A. tsugae Density', 'FontSize', 16)
...
ax.FontSize = 16;
%adelgid in black
plot(t_full ./ 52, a_final_plot, 'Color', [0.3, 0.3, 0.3], 'LineWidth', 3); 
xlabel('Time (years) starting week 43 (October)', 'FontSize', 16)
ylabel('A. tsugae density (per cm)', 'FontSize', 16)
ylim([0,37])

legend('S. tsugae only','L. nigrinus only', 'Location','northwest', 'FontSize', 16)

% save figure as .jpeg file
filename = ['ALS_AL_AS.jpeg'];
f = gcf;
f.Position(3:4) = [400, 300]
exportgraphics(f, filename, 'Resolution', 1000)
